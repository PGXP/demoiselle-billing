...
public class ProcessorFailHandler {
     ...
     * @param trail
     */
    protected void onFailProcessor(@Observes @BillingProcessorFail Trail trail) {
    ...
    private static final Logger LOG = Logger.getLogger(ProcessorFailHandler.class.getName());
}
